/**
 Tasks cribbed from jQuery to handle building custom landmark parsers.
...
module.exports = function( grunt ) {
  ...
  // Translation example
  //
  //   grunt custom_landmark:+ajax,-dimensions,-effects,-offset
  //
  // Becomes:
  //
  //   grunt build:*:*:+ajax:-dimensions:-effects:-offset
  grunt.registerTask( "custom_landmark", function() {
