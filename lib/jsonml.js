...
exports.toHtml = function( jsonml ) {
  ...
  return convert_tree_to_html( jsonml, refs );
}
...
function convert_tree_to_html( tree, references ) {
  ...
  switch ( jsonml[ 0 ] ) {
    ...
    case "link_ref":
      ...
      var ref = references[ jsonml[ 1 ].ref ];
      ...
      if ( ref ) {
        ...
        jsonml[ 1 ].href = ref.href;
        if ( ref.title ) {
          jsonml[ 1 ].title = ref.title;
        }
