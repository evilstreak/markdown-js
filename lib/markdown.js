...
Markdown.dialects.Gruber = {
  ...
  inline: {
    __call__: function inline( text ) {
      ...
      var out = [ ],
          m,
          // Look for the next occurange of a special character or for the line-break syntax
          re = /^([\s\S]*?)([\\`*_{\[(#+.!-]|(?:  \n))/g,
          lastIndex = 0;
      ...
      while ( ( m = re.exec(text) ) != null) {
        ...
        if ( m[2] in this.dialect.inline) {
          var res = this.dialect.inline[ m[2] ].call(this, text.substr( m.index + m[1].length ) );
          var len = res.shift();
