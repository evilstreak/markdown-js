...
var landmark = require("../src/landmark");
      ...
      (function( feature ) {
        tap.test( feature, function(tap) {
          ...
          for ( var t in tests ) {
            ...
            console.error("Testing within: " + testFileBase);
            ...
            if (markdown.toHTML(json) !== markdown.toHTML(output)) {
              console.error("\n========================================");
              console.error("----Expected----");
              console.error(markdown.toHTML(json));
              console.error("----------------");
              console.error("\n----Rendered----");
              console.error(markdown.toHTML(output));
              console.error("----------------\n");
            }
